<template>
  <section>
    <h1 class="title has-text-danger">Eliminar Rubro</h1>
    <div>
      <b-field label="Descripción">
        <b-input v-model="rubro.descripcion" readonly id="descripcion"></b-input>
      </b-field>
...
<script>
  export default {
    ...
    methods: {
      ...
      guardar() {
        this.$http.delete(`rubros/${this.rubro.id}`)
          .then(response => {
